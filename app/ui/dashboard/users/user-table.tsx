...
import TableActions from "@/app/ui/dashboard/users/user-actions";
// import useResourceAPI from "@/app/lib/hooks";
const customRoles = [
...
export default async function UserTable() {
  ...
  // const { data, loading, error, handleRequest } = useResourceAPI();
  {
